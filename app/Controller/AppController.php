...
class AppController extends Controller {
    ...
    public function beforeFilter() {
        ...
        if($this->Auth->User("id")) {
            ...
            $this->Auth->allow('license','login','validate_emailurl','forgotpassword','session_maintain','googleConnect', 'googleSignup', 'setGoogleInfo','ajaxpostcase','ajaxemail','register_user','invitation','emailUpdate','step');
