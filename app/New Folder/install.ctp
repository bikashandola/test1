	...
	<body>
		<div id="container">
			...
			<div style="position:relative; z-index:9;">
				...
				<div id="prev_btn" style="float:right; margin-top:20px;display:none;">
	...
	if(step != 4 && step != 5){
		$.post('<?php echo HTTP_ROOT."users/step"; ?>',{'step':step}, function(res){
			...
			if(step == 3 && $('ul li:nth-child(5)').html('Smtp Configuration')){
				if($('#error').val() == 1){
					$('#nxt_btn').html("<button type='button' class='verify' value='Verify' onclick='check(3);'>Check Again </button>");
				}else{
				...
				if($('#error').val() == 1){
					$('#nxt_btn').html("<button type='button' class='verify' value='Verify' onclick='check(6);'>Check Again </button>");
				}else{
					$('#prev_btn').show();
					$('#prev_btn').html("<button type='button' class='prev' value='previous' onclick='check("+(step-1)+");'>Prev </button>");
				...
				if($('#error').val() == 1){
					$('#nxt_btn').html("<button type='button' class='verify' value='Verify' onclick='check("+step+");'>Check Again </button>");
				}else{
